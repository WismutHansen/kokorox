...
impl ModelManager {
    ...
    pub async fn get_deepphonemizer_paths(
        &self,
        language: &str,
        ...
        if !config_path.exists() {
            self.create_deepphonemizer_config(&config_path, &model_name, language)
                .await?;
        }
    ...
    async fn create_deepphonemizer_config(
        &self,
        config_path: &Path,
        model_name: &str,
        language: &str,
